...
//        Customer customer = new Customer("Daniel", 100000.00);
//        customer.addTransaction(200.00);
//        System.out.println(customer.getName());
//        System.out.println(customer.getTransactions());


//        Branch branch = new Branch("Portland");
//        System.out.println(branch.newCustomer("Bob", 5.0));
//        System.out.println(branch.newCustomer("Bob", 5.0));
//        System.out.println(branch.addCustomerTransaction("Bob", 5.0));
//
